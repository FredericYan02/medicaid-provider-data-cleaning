...
Purpose:
Clean and standardize the Vermont Medicaid Provider Exclusion dataset.

Input:
    raw_data/Vermont.xlsx

Output:
    cleaned_data/Vermont_Cleaned.xlsx
    cleaned_data/Vermont_Cleaned.csv
"""
...
RAW_FILE = BASE_DIR / "raw_data" / "Vermont.xlsx"
OUTPUT_DIR = BASE_DIR / "cleaned_data"
OUTPUT_EXCEL = OUTPUT_DIR / "Vermont_Cleaned.xlsx"
OUTPUT_CSV = OUTPUT_DIR / "Vermont_Cleaned.csv"
...
def main():
    ...
    provider_name_col = find_column(df, ["provider_name","name","provider","individual_name","entity_name","individual_entity_name"])
    ...
    provider_type_col = find_column(df, ["provider_type","type","provider_category","specialty","license_type"])
    date_col = find_column(df, ["action_date","effective_date","exclusion_date","termination_date","date"])
    reason_col = find_column(df, ["exclusion_reason","reason","action","comments","basis","description"])
    ...
    print("Vermont data cleaning completed.")
