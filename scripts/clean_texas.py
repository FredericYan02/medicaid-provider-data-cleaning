...
Purpose:
Clean and standardize the Texas Medicaid Provider Exclusion dataset.

Input:
    raw_data/Texas.xlsx

Output:
    cleaned_data/Texas_Cleaned.xlsx
    cleaned_data/Texas_Cleaned.csv
"""
...
RAW_FILE = BASE_DIR / "raw_data" / "Texas.xlsx"
OUTPUT_DIR = BASE_DIR / "cleaned_data"
OUTPUT_EXCEL = OUTPUT_DIR / "Texas_Cleaned.xlsx"
OUTPUT_CSV = OUTPUT_DIR / "Texas_Cleaned.csv"
...
def main():
    ...
    for _, row in df.iterrows():
        ...
        npi, npi_valid = clean_npi(raw_npi_value)
    ...
    print("Texas data cleaning completed.")
